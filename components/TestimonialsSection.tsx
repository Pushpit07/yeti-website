...
export function TestimonialsSection({
  ...
  const renderTestimonialCard = (testimonial: Testimonial, index: number) => (
    <div key={index} className="w-[400px] bg-white rounded-2xl p-6 md:p-8 border border-border hover:border-primary transition-all hover:shadow-lg group shrink-0">
      <div className="mb-6">
