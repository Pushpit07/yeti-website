        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-6 sm:mb-12 pb-8">
          ...
          <div className="mb-6 lg:mb-0">
            ...
            <div className="flex items-center gap-4 mt-6 lg:hidden">
              <a
                href="https://www.linkedin.com/company/yeti-dresden/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/yeti_dresden/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.youtube.com/@YETI-program"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://chat.whatsapp.com/Gf290Qt4NEp7Chb070Dxmp"
                target="_blank"
                rel="noopener noreferrer"
