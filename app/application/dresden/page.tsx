...
export const metadata = {
  title: "Application Dresden | YETI",
  description: "Everything you need to know about applying to YETI Dresden - FAQs, Timeline, Tips & Tricks",
}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-3xl border border-neutral-200 p-8 md:p-12 shadow-sm mb-12 mt-16">
            ...
            <p className="text-base text-neutral-700 leading-relaxed mb-8">
              To apply for the <span className="font-bold text-neutral-900">YETI Dresden</span> program, you will need to meet the following personal requirements:
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 mb-8">
              ...
              <div className="border-l-4 border-primary pl-4">
                ...
                <p className="text-neutral-600 text-sm leading-relaxed">
                  You&apos;re available one day per week for on-site sessions at YETI Dresden HQ (typically Thursdays)
                </p>
              </div>
            </div>
          ...
          <div className="text-center bg-white rounded-3xl border border-neutral-200 p-10 md:p-12 shadow-sm">
            ...
            <div className="mt-8 pt-6 border-t border-neutral-200">
              <p className="text-neutral-600 text-sm">
                If you want to apply for Leipzig instead, please{" "}
                <Link href="/application/leipzig" className="text-primary font-bold hover:underline">
                  click here →
                </Link>
              </p>
            </div>
      ...
      <Section>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Discuss your unique skills, experiences, and what you&apos;ll contribute to the Dresden community.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary text-xl mt-1">✓</span>
        ...
        <div className="max-w-4xl mx-auto pb-8">
          ...
          <p className="text-center text-xl text-muted-foreground mb-12">
            A simple three-step process to join the YETI Dresden community
          </p>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-muted-foreground mb-4">
                    ...
                    This puts you in our application pool for the upcoming {getGenerationText('dresden')}.
                  </p>
            ...
            <div className="bg-white rounded-2xl border-2 border-border p-8 hover:border-primary/50 transition-all">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-muted-foreground">
                    If we&apos;re convinced by your application and interview, you&apos;ll receive your acceptance to the YETI Dresden program
